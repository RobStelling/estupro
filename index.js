...
if (lang) {
  d3.select("#tituloPagina").html("Rape cases in Rio de Janeiro from 2013 to 2016");
  //d3.select("#comentario").html("2016 numbers based on January to November 2016 average");
